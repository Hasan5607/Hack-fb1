#---------------------[ INFO ]---------------------#
#JOIN : https://www.facebook.com/profile.php?id=100092174587959
#JOIN : https://t.me/cyberxofbangladesh0
#---------------------[MODULES ]---------------------#
...
logo ="""
 ...
 CCCCCCCCCCCCCXXXXXXX       XXXXXXX     OOOOOOOOO     FFFFFFFFFFFFFFFFFFFFFFBBBBBBBBBBBBBBBBB   
     CCC::::::::::::CX:::::X       X:::::X   OO:::::::::OO   F::::::::::::::::::::FB::::::::::::::::B  
   CC:::::::::::::::CX:::::X       X:::::X OO:::::::::::::OO F::::::::::::::::::::FB::::::BBBBBB:::::B 
  C:::::CCCCCCCC::::CX::::::X     X::::::XO:::::::OOO:::::::OFF::::::FFFFFFFFF::::FBB:::::B     B:::::B
 C:::::C       CCCCCCXXX:::::X   X:::::XXXO::::::O   O::::::O  F:::::F       FFFFFF  B::::B     B:::::B
C:::::C                 X:::::X X:::::X   O:::::O     O:::::O  F:::::F               B::::B     B:::::B
C:::::C                  X:::::X:::::X    O:::::O     O:::::O  F::::::FFFFFFFFFF     B::::BBBBBB:::::B 
C:::::C                   X:::::::::X     O:::::O     O:::::O  F:::::::::::::::F     B:::::::::::::BB  
C:::::C                   X:::::::::X     O:::::O     O:::::O  F:::::::::::::::F     B::::BBBBBB:::::B 
C:::::C                  X:::::X:::::X    O:::::O     O:::::O  F::::::FFFFFFFFFF     B::::B     B:::::B
C:::::C                 X:::::X X:::::X   O:::::O     O:::::O  F:::::F               B::::B     B:::::B
 C:::::C       CCCCCCXXX:::::X   X:::::XXXO::::::O   O::::::O  F:::::F               B::::B     B:::::B
  C:::::CCCCCCCC::::CX::::::X     X::::::XO:::::::OOO:::::::OFF:::::::FF           BB:::::BBBBBB::::::B
   CC:::::::::::::::CX:::::X       X:::::X OO:::::::::::::OO F::::::::FF           B:::::::::::::::::B 
     CCC::::::::::::CX:::::X       X:::::X   OO:::::::::OO   F::::::::FF           B::::::::::::::::B  
        CCCCCCCCCCCCCXXXXXXX       XXXXXXX     OOOOOOOOO     FFFFFFFFFFF           BBBBBBBBBBBBBBBBB   
...
def XYZ():
    ...
    print(f" {GREEN}PREMIUM USER          {WHITE}: {CXOFB}Mr {ORANGE} {NameX}")
    print(f"{BLUE}══════════════════════════════════════════════════")
    print(f"{RED}[01] {WHITE}BD RANDOM CLONE ")
    print(f"{RED}[02] {WHITE}C E O_ 🙂 ")
    print(f"{RED}[03] {WHITE}OWNER TELEGRAM")
    ...
    if TANJID in ["1","01"]:
        ...
        os.system("xdg-open https://t.me/cyberxofbangladesh0")
        XYZ()
    elif TANJID in ["0","00"]:
       exit()
    else:
